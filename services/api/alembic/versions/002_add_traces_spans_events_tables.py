...
def upgrade() -> None:
    ...
    op.create_table('spans',
        ...
        sa.Column('span_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table('flowise_executions',
        sa.Column('execution_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('workflow_id', sa.String(), nullable=False),
        sa.Column('trace_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('timestamp', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.Column('status', sa.String(), nullable=False, default='OK'),
        sa.Column('flowise_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.ForeignKeyConstraint(['trace_id'], ['traces.trace_id'], ),
